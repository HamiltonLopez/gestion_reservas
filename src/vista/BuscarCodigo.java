...
public class BuscarCodigo extends javax.swing.JFrame {
    ...
    public BuscarCodigo(Controlador controlador) {
        initComponents();
...
if(txtNoDocumento.getText().isEmpty()){
    JOptionPane.showMessageDialog(null, "Ingrese el código de la reserva que desea consultar");
}else{
     int documento = Integer.parseInt(txtNoDocumento.getText());
        leerLista(controlador.buscarReservarXCodigo(documento));
}
       
    }//GEN-LAST:event_jButton2ActionPerformed
    public void leerLista(Reserva reserva) {

        if (reserva == null) {
            JOptionPane.showMessageDialog(null, "El número ingresado no está relacionado con reservas");
        } else {
